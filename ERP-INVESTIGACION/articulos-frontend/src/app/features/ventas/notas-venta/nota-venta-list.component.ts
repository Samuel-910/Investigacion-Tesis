...
@Component({
    ...
    templateUrl: './nota-venta-list.component.html'
})
export class NotaVentaListComponent implements OnInit {
    ventas = signal<any[]>([]);
